...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			const head_nodes = head_selector('svelte-197udfl', document.head);
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-pm4uia");
...
function create_if_block$1(ctx) {
	...
	icon0 = new Component$1({ props: { icon: "mdi:instagram" } });
	...
	return {
		...
		l(nodes) {
			...
			li = claim_element(nav_nodes, "LI", { class: true });
		...
		h() {
			attr(a, "href", "http://www.instagram.com/projectgoldworld");
			attr(a, "aria-label", "instagram");
			attr(a, "class", "svelte-pm4uia");
			attr(li, "class", "svelte-pm4uia");
			attr(button, "id", "close");
			attr(button, "aria-label", "Close Navigation");
			attr(button, "class", "svelte-pm4uia");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-pm4uia");
		},
		m(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-pm4uia");
			attr(a1, "href", "http://www.instagram.com/projectgoldworld");
			attr(a1, "aria-label", "instagram");
			attr(a1, "class", "svelte-pm4uia");
			attr(li, "class", "svelte-pm4uia");
			attr(nav, "class", "svelte-pm4uia");
			attr(div0, "class", "desktop-nav svelte-pm4uia");
			attr(a2, "href", "/");
			attr(a2, "class", "logo svelte-pm4uia");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-pm4uia");
			attr(header, "class", "section-container svelte-pm4uia");
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			attr(div0, "class", "section-container content svelte-1oawp55");
...
function create_fragment$4(ctx) {
	...
	component_2 = new Component$3({
			props: {
				content: {
					"html": "<p>Project Gold was founded in 2017 to identify talent and develop careers for musicians and creatives.</p><p>As a talent management company we help our clients navigate the dynamic and constantly evolving entertainment space. Project Gold is focused on developing long-term career strategies, identifying opportunities for growth, and building meaningful relationships and businesses.</p><p>We work alongside our clients to develop their skills, talents, and overall artistic vision. Using our significant experience we oversee all aspects of their careers: from the creation process to complex marketing and promotional campaigns to coordinating touring and live performances on a global scale.</p><p>Our clients have released music independently and through major labels, they have appeared on podcasts and created their own shows. They have worked with the biggest streaming platforms to make original series and films. They have published books, written original songs and scored soundtracks. On their behalf we have managed hundreds of brand partnerships, appeared at every fashion week and built relationships with the world’s leading consumer goods brands.</p><p>We take great pride in our work and our clients, whose vision we help facilitate.</p>",
					"markdown": "Project Gold was founded in 2017 to identify talent and develop careers for musicians and creatives.\n\nAs a talent management company we help our clients navigate the dynamic and constantly evolving entertainment space. Project Gold is focused on developing long-term career strategies, identifying opportunities for growth, and building meaningful relationships and businesses.\n\nWe work alongside our clients to develop their skills, talents, and overall artistic vision. Using our significant experience we oversee all aspects of their careers: from the creation process to complex marketing and promotional campaigns to coordinating touring and live performances on a global scale.\n\nOur clients have released music independently and through major labels, they have appeared on podcasts and created their own shows. They have worked with the biggest streaming platforms to make original series and films. They have published books, written original songs and scored soundtracks. On their behalf we have managed hundreds of brand partnerships, appeared at every fashion week and built relationships with the world’s leading consumer goods brands.\n\nWe take great pride in our work and our clients, whose vision we help facilitate.\n\n"
				}
			}
		});
